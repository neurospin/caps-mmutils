...
SAMPLE_DATE_FILES = {
    ...
    "qt1": Enum(
        ...
        gre20=(
            "nsap_url", "qt1/a20.nii.gz", "1ceddb5cb022833324756f301f74a2fe"),
        gre5dcm=(
            "nsap_url", "qt1/a5.dcm", "95ae7ff9236093dba03ed6a71a233cd6"),
        gre20dcm=(
            "nsap_url", "qt1/a20.dcm", "c3329a8cf7f2459744340e44032c9525"),
        afiphasedcm=(
            "nsap_url", "qt1/phase.dcm", "1d2ef1b1c91b6f7ce4d9cd12b78595e6"),
        afiamplitudedcm=(
            "nsap_url", "qt1/mag.dcm", "009ac33d70a6bc9663440f8f64f93d0f"),
        echonumbers=[1, 2, 3, 4],
        m0factor=1.9),
    "fa_1mm": Enum(
        template=(
            "fsl_dir", "data/standard/FMRIB58_FA_1mm.nii.gz",
            "a6f9a5222f64eff5f61b21b5e6e1c67d"),
        nl_config=(
            "fsl_dir", "etc/flirtsch/FA_2_FMRIB58_1mm.cnf",
            "c1fcda805d0feedf68894ac7f494410d")),
    "mni_1mm": Enum(
        mni=(
            "fsl_dir", "data/standard/MNI152_T1_1mm.nii.gz",
            "fdd164e97d9d576aea4b83b8317489ed"),
        brain=(
            "fsl_dir", "data/standard/MNI152_T1_1mm_brain.nii.gz",
            "7c47f203858f57c50ee93bcf7b0662fc"),
        mask=(
            "fsl_dir", "data/standard/MNI152_T1_1mm_brain_mask.nii.gz",
            "47b8c7f50533688494aa44ff22d5f988"),
        mesh=(
            "nsap_url", "MNI152_T1_1mm_Bothhemi.gii",
            "67a0af59da5fa7c6ff16358db606566a"),
        erode_mesh=(
            "nsap_url", "MNI152_T1_1mm_Bothwhite.gii",
            "0b0aebcabfd9a5ebb1189d56298cb0e0")),
    "mni_2mm": Enum(
        mni=(
            "fsl_dir", "data/standard/MNI152_T1_2mm.nii.gz",
    ...
    "spm_auditory": Enum(
        fmri=(
            "nsap_url", "spm_auditory_fmri_data.nii.gz",
            "90b37996c31a9c6ff7101a4cc380e2aa"),
        anat=(
            "nsap_url", "spm_auditory_t1.nii.gz",
            "a6cd202f033433b6184066ef8da77d5b"),
        TR=7,
        timings=(
            "nsap_url", "spm_auditory_timings.txt",
    ...
    "tpm": Enum(
        ...
        wm=(
            "spm_dir", "tpm/white.nii", "46e18b2fe947457b52bdd69573853692"),
        csf=(
            "spm_dir", "tpm/csf.nii", "861f7bba117a504ee5e4291a065d929d")),
    "localizer": Enum(
        fmri=(
            "nsap_url", "fmri_localizer.nii.gz",
            "9457918182ef66e5d5b9473fe7d1d1b7"),
        anat=(
            "nsap_url", "t1_localizer.nii.gz",
            "9617b36e5510a4783038c63241da21d4"),
        mean=(
            "nsap_url", "mean_fmri_localizer.nii.gz",
            "2aa39900027e3ff89f0d66804521e153"),
        TR=2.4,
        timings=(
            "nsap_url", "localizer_timings.txt",
            "c5f10b621fbb3ca689ad9fe41a7dc9a6"),
        fmridcm=(
            "nsap_url", "func.tar.gz", "0de40a9970e5b7f3f02b62db6f18f417"),
        anatdcm=(
            "nsap_url", "anat.tar.gz", "2aa880e13a746cd66f88ba56d053b063"),
        preproc_fmri=(
            "nsap_url", "swra_localizer.nii",
            "70dfcb4872311d57ffe9bc571490bab4"),
        onsets=(
    ...
    "dwi": Enum(
        ...
        bvecs=(
            "nsap_url", "DTI30s010.bvec", "0f801f03f15cd3e5d20609975661f957"),
        bvals=(
            "nsap_url", "DTI30s010.bval", "98ff765baacda3b6ae3d4f0b06360bb5"),
        fa=(
            "nsap_url", "DTI30s010_fa.nii.gz",
            "9e31f6306d0e616e9a0c0e5e5e892238"),
        mask=(
            "nsap_url", "DTI30s010_mask.nii.gz",
            "4cd58aeec91003af8a4d040494922140"),
        tensor=(
            "nsap_url", "DTI30s010_tensor2.nii.gz",
            "b2bc7f7fc0e196b227c758429f263dcc")),
    "brainvisa_palette": Enum(
        edouard=(
            "nsap_url", "palette_signed_values_blackcenter.tiff",
